  ...
  return (
    <>
      <section className="w-full container mx-auto ">
        ...
        <section className="w-full flex  justify-center gap-20 mt-30 px-20">
          <Carousel
            opts={{
              align: "start",
            }}
...
export function SpanTecnologia({ nome }: { nome: string }) {
  return (
    <span className="border text-[12px] py-1 px-4 rounded-full border-blue-400 bg-blue-600/5 text-blue-400 w-fit">
      {nome}
    </span>
  );
}
